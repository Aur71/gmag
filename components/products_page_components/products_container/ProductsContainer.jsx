...
import filterByActiveFilters from '../functions/filter_products/filterByActiveFilters';
import sortData from '../functions/filter_products/sortData';
...
const ProductsContainer = ({ data, layout }) => {
  ...
  const filteredByFilters = filterByActiveFilters(data, activeFilters);
